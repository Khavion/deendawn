...
- [~] E11. IN PROGRESS — About/attribution/privacy screen DONE 2026-07-13 (manifest-driven, Tanzil clause test-guarded, i18n ×3). Remaining: recitation audio (BLOCKERS B), tip jar (RevenueCat), onboarding first-run flow, offline E2E suite, store prep
